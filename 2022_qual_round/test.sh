...
mkdir out/$file
# ./test in/a.txt out/$file/a.txt
# ./test in/b.txt out/$file/b.txt
# ./test in/c.txt out/$file/c.txt
# ./test in/d.txt out/$file/d.txt
# ./test in/e.txt out/$file/e.txt
./test in/f.txt out/$file/f.txt
